...
export class DepositsController {
  ...
  @Public() @Get("external/reservations/:reservationId/reminder-eligibility") async reminder(@Headers("x-api-key") apiKey: string, @Param("reservationId") reservationId: string) { return this.service.reminderEligibility(await this.resolveRestaurant(apiKey), reservationId); }
