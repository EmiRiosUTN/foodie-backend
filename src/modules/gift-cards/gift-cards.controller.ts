...
export class GiftCardsController {
  ...
  @Public()
  @Post("external/gift-cards/orders") externalCreate(@Headers("x-api-key") apiKey: string, @Headers("idempotency-key") idempotencyKey: string | undefined, @Body() body: unknown) { return this.service.createExternal(apiKey, orderSchema.parse(body), idempotencyKey); }
  @Public()
