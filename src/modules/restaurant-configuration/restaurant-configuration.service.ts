...
export class RestaurantConfigurationService {
  ...
  async getPersonalize(user: RequestUser) {
    ...
    const [customization, booking, specials, faqs, assistantUpdates] = await Promise.all([
